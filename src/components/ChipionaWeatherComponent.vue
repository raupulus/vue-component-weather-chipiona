                        ...
                        <div class="resume-weather-container">
                            ...
                            <div v-show="navigation.wind"
                                ...
                                <h1 class="resume-weather-temp">
                                    {{ windAverageRounded }} km/h
                                </h1>

                                <h3 class="resume-weather-desc">
                                    Min: {{ windMinRounded }} km/h
                                    <br />
                                    Max: {{ windMaxRounded }} km/h
                                </h3>
                            </div>
                            ...
                            <div v-show="navigation.tvoc"
                                ...
                                <h3 class="resume-weather-desc">
                                    TVOC: {{ airQualityTvocRounded }}
                                    <br />
                                    CO2-ECO2: {{ airQualityCo2Eco2Rounded }}
                                </h3>
                            </div>
...
export default defineComponent({
    ...
    computed: {
        temperatureRounded(): number {
            return Math.round(this.info.temperature * 100) / 100;
        },

        humidityRounded(): number {
            return Math.round(this.info.humidity * 100) / 100;
        },

        pressureRounded(): number {
            return Math.round(this.info.pressure * 100) / 100;
        },

        windAverageRounded(): number {
            return Math.round(this.wind.average * 100) / 100;
        },

        windMinRounded(): number {
            return Math.round(this.wind.min * 100) / 100;
        },

        windMaxRounded(): number {
            return Math.round(this.wind.max * 100) / 100;
        },

        airQualityRounded(): number {
            return Math.round(this.air_quality.quality * 100) / 100;
        },

        airQualityTvocRounded(): number {
            return Math.round(this.air_quality.tvoc * 100) / 100;
        },

        airQualityCo2Eco2Rounded(): number {
            return Math.round(this.air_quality.co2_eco2 * 100) / 100;
        },

        lightIndexRounded(): number {
            return Math.round(this.light.index * 100) / 100;
        },

        lightUvaRounded(): number {
            return Math.round(this.light.uva * 100) / 100;
        },

        lightUvbRounded(): number {
            return Math.round(this.light.uvb * 100) / 100;
        }
    }
});
